 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xs:head.001.001.01}PersonIdentificationSchemeName1Choice" minOccurs="0"/>
 *         &lt;element name="Issr" type="{urn:iso:std:iso:20022:tech:xs:head.001.001.01}Max35Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GenericPersonIdentification1", namespace = "urn:iso:std:iso:20022:tech:xs:head.001.001.01", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
